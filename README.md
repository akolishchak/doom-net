...
Doom-net implements various RL models in [ViZDoom](http://vizdoom.cs.put.edu.pl/) environment. See [Doom-net-pytorch](https://github.com/akolishchak/doom-net-pytorch) for PyTorch's version.
